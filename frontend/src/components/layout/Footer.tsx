    ...
    <footer className="bg-gray-900 text-gray-400 mt-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <span className="text-xl font-bold text-emerald-400">eRevive</span>
            <span className="text-sm text-gray-500 ml-1">NW</span>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              ...
              <li><Link href="/register" className="text-sm hover:text-white transition-colors">Get Started</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider">Service Area</h3>
            <p className="mt-3 text-sm">
              Seattle, WA and surrounding areas (ZIP codes 980xx, 981xx)
            </p>
